...
#     print(round(rfm[rfm['prob_alive']>0.6].count()))
    ...
    rfm
#     print(rfm.sort_values('CLT Sales', ascending=False).head(10))

#     print('Mean CLT Sales ',round(rfm['predicted CLV'].mean(),0))

#     print('Sum CLT Sales ',round(rfm['predicted CLV'].sum(),0))

#     print('Prob Alive ',round(rfm.describe(),2))

#     print('Predicted CLT Sales stats ',round(rfm['predicted CLV'].describe(),2))


#     print('Number of alive (>.50%)Customers in t days ',rfm[rfm['prob_alive']>0.50].count())

#     print('Number of alive (>.75%)Customers in t days ',rfm[rfm['prob_alive']>0.75].count())

#     print('Number of alive Customers in t days ',rfm['prob_alive'].value_counts(bins=3))
